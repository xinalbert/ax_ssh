...
- 最近依据：2026-08-10 将 Terminal 分屏收紧为“一棵 PaneTree 属于一个可见 Terminal Tab”；子 pane 保留独立 UUID/worker/model/认证阶段但不进入 Tab 条，窗口路由分别维护可见 Tab 与焦点 pane，Tab 循环/拖动/关闭及 detached/Return 按整组处理，SFTP companion 仍为独立可见 Tab。
